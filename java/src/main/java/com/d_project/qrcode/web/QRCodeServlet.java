 ...
 * @see com.d_project.qrcode.ErrorCorrectionLevel
 */
...
public class QRCodeServlet extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		int errorCorrectionLevel = parseErrorCorrectionLevel(getParameter(request, "e", "H") );

    	QRCode qrcode = getQRCode(data,	typeNumber, errorCorrectionLevel);
	...
	private static QRCode getQRCode(String text, int typeNumber, int errorCorrectionLevel) {
    ...
    private static int parseErrorCorrectionLevel(String ecl) {
